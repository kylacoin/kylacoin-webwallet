    ...
    <div class="container">
		<nav role="navigation" class="wheader">
			<div id="menuToggle">
				...
				<span></span>
				<ul id="menu">
					<li><a class="social-link" href="https://kylacoin.com" title="Kylacoin" target="_blank" rel="nofollow noopener">Website</a></li>
					<li><a class="social-link" href="https://kcnxp.com" title="Kylacoin Explorer" target="_blank" rel="nofollow noopener">Explorer</a></li>
					<li><a class="social-link" href="https://github.com/kylacoin/kylacoin-webwallet/" title="Source Code" target="_blank" rel="nofollow noopener">Source Code</a></li>
					<li><a class="social-link" @click="exit">Exit</a></li>
				</ul>
			</div>
			<span class="wallettitle">Kylacoin Web Wallet (v{{$nuxt.$config.clientVersion}})</span>
		</nav>
		<div class="wcontent">
			...
			<div class="page" id="page-send">
				...
				<input id="page_send_address" class="input is-rounded" type="text" placeholder="kc1...">
...
export default {
  ...
  methods: {
	...
	preload() {
		...
		webwallet.network = {
		  messagePrefix: '\x19Kylacoin Signed Message:\n',
		  bech32: 'kc',
		  bip32: {
			public: 0x038f332e,
			private: 0x038f2ef4,
		...
		webwallet.explorer_api_url = 'https://api.kcnxp.com';

		webwallet.bip44_path = `m/44'/2368'/0'/0`;
